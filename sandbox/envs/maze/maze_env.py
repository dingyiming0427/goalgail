...
from sandbox.envs.maze.maze_env_utils import construct_maze
...
from sandbox.envs.goal_env import GoalEnv, GoalExplorationEnv
...
class MazeEnv(ProxyEnv, Serializable):
    ...
    MAZE_0 = [(1, 1), (1, 2), (1, 3), (2, 3), (3, 3), (3, 2), (3, 1)]

    MAZE_11 = [(3, 3), (3, 4), (3, 5), (2, 5), (1, 5), (1, 4), (1, 3), (1, 2), (1, 1),
               (2, 1), (3, 1), (4, 1), (5, 1), (5, 2), (5, 3), (5, 4), (5, 5)]

    MAZE_13 = [(5, 1), (5, 2), (5, 3), (5, 4), (5, 5), (4, 5), (3, 5), (3, 4), (3, 3),
               (3, 2), (3, 1), (2, 1), (1, 1), (1, 2), (1, 3), (1, 4), (1, 5)]

    MAZE_14 = [(3, 4), (3, 5), (3, 6), (2, 6), (1, 6), (1, 5), (1, 4), (1, 3), (1, 2),
               (2, 2), (3, 2), (4, 2), (5, 2), (5, 3), (5, 4), (5, 5), (5, 6), (6, 6),
               (7, 6), (7, 5), (7, 4), (7, 3), (7, 2)]
    ...
    def struct_to_coord(self, struct):
        size_scaling = self.MAZE_SIZE_SCALING
        i = struct[0]
        j = struct[1]
        return (j * size_scaling - self._init_torso_x, i * size_scaling - self._init_torso_y)

    def coord_to_struct(self, coord):
        x = coord[0]
        y = coord[1]
        j = int(round((x + self._init_torso_x) / self.MAZE_SIZE_SCALING + 0.000001)) # add a small number to make it round 0.5 to 1
        i = int(round((y + self._init_torso_y) / self.MAZE_SIZE_SCALING + 0.000001))
        return (i, j)
    ...
    def find_empty_space(self):
        ...
        empty_space = []
        if self.LINEARIZED:
            for struct in self.LINEARIZED:
                empty_space.append(self.struct_to_coord(struct))
        else:
            for i in range(len(structure)):
                if  i % subsample_rate == 0:
                    for j in range(len(structure[0])):
                        if structure[i][j] == 'r' or structure[i][j] == 'g' or structure[i][j] == 0 and j % subsample_rate == 0:
