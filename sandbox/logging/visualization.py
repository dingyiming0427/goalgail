...
from sandbox.state.evaluator import evaluate_states, convert_label
...
def plot_labeled_samples(samples, sample_classes=None, text_labels=None, markers=None, fname=None, limit=None,
                         center=None, size=1000, colors=('r', 'g', 'b', 'm', 'k'), bounds=None, maze_id=None, s=None):
    """
    :param samples: 
    ...
    if np.size(center) >= 3:
        ...
        if bounds is not None:
            ...
            ax.add_patch(patches.Rectangle((-9, -7), 4, 18, fill=True, edgecolor="none", facecolor='0.4'))
            ax.add_patch(patches.Rectangle((-9, -7), 18, 2, fill=True, edgecolor="none", facecolor='0.4'))
            ax.add_patch(patches.Rectangle((-9, 9), 18, 2, fill=True, edgecolor="none", facecolor='0.4'))
            ax.add_patch(patches.Rectangle((5, -7), 4, 18, fill=True, edgecolor="none", facecolor='0.4'))
            ax.add_patch(patches.Rectangle((-5, 5), 8, 2, fill=True, edgecolor="none", facecolor='0.4'))
            ax.add_patch(patches.Rectangle((-3, 1), 8, 2, fill=True, edgecolor="none", facecolor='0.4'))
            ax.add_patch(patches.Rectangle((-3, -3), 6, 2, fill=True, edgecolor="none", facecolor='0.4'))
